...
public class MainActivity extends AppCompatActivity {
    ...
    public void Filipino (View v){
        Intent i = new Intent (this, Filipino.class);
        startActivity(i);
    }
    public void Italian (View v){
    ...
    public void Adobo (View v){
        Intent i = new Intent (this, Adobo.class);
        startActivity(i);
    }

    public void Omelet (View v){
        Intent i = new Intent (this, Omelet.class);
        startActivity(i);
    }

    public void Sinigang (View v){
